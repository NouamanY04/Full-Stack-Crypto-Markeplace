...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (query) {
        ...
        console.log("No 'coin' query parameter found; redirecting to index.html");
    }
})

async function fetchcoinInfo(query) {
    console.log('async func executed waiting for result');
    ...
    try {
        ...
        coinInfoError.style.display = 'block';
        console.log(error)
    }
}
...
function displayCoinInfo(coin) {
         ...
         <div class="logo">
                    ...
                    <div class="status">
                        ...
                        <div class="item">
                            ...
                            <p class="num">$${coin.market_data.market_cap.usd !== null ? coin.market_data.market_cap.usd.toLocaleString(undefined, {
                                minimumFractionDigits: 3, maximumFractionDigits: 3
                            }) : 'N/A'}</p>
                        </div>
                        <div class="item">
                            <p class="str">Current Price</p>
                            <p class="num">$${coin.market_data.current_price.usd !== null ? coin.market_data.current_price.usd.toLocaleString(undefined, {
                                minimumFractionDigits: 3, maximumFractionDigits: 3
                            }) : 'N/A'}</p>
                        </div>
                        <div class="item">
                            <p class="str">All Time High</p>
                            <p class="num">$${coin.market_data.ath.usd !== null ? coin.market_data.ath.usd.toLocaleString(undefined, {
                                minimumFractionDigits: 3, maximumFractionDigits: 3
                            }) : 'N/A'}</p>
                        </div>
                        <div class="item">
                            <p class="str">All Time Low</p>
                            <p class="num">$${coin.market_data.atl.usd !== null ? coin.market_data.atl.usd.toLocaleString(undefined, {
                                minimumFractionDigits: 3, maximumFractionDigits: 3
                            }) : 'N/A'}</p>
                        </div>
                        <div class="item">
                            <p class="str">Total Volume</p>
                            <p class="num">$${coin.market_data.total_volume.usd !== null ? coin.market_data.total_volume.usd.toLocaleString(undefined, {
                                minimumFractionDigits: 3, maximumFractionDigits: 3
                            }) : 'N/A'}</p>
                        </div>
                        <div class="item">
                        ...
                        <div class="item">
                            ...
                            <p class="num">${coin.market_data.max_supply !== null ? coin.market_data.max_supply.toLocaleString(undefined, {
                                minimumFractionDigits: 3, maximumFractionDigits: 3
                            }) : 'N/A'}</p>
                        </div>
                        <div class="item">
                            <p class="str">Circulating Supply</p>
                            <p class="num">${coin.market_data.circulating_supply !== null ? coin.market_data.circulating_supply.toLocaleString(undefined, {
                                minimumFractionDigits: 3, maximumFractionDigits: 3
                            }) : 'N/A'}</p>
                        </div>
                    </div>
    ...
    rightSec.innerHTML = `
                <div class="status">
                    ...
                    <div class="container">
                        ...
                        <div class="item">
                            ...
                            <p class="num">$${coin.market_data.high_24h.usd != null ? coin.market_data.high_24h.usd.toLocaleString(undefined, {
                                minimumFractionDigits: 3, maximumFractionDigits: 3
                            }) : 'N/A'}</p>
                        </div>
                        <div class="item">
                            <p class="str">24h Low</p>
                            <p class="num">$${coin.market_data.low_24h.usd != null ? coin.market_data.low_24h.usd.toLocaleString(undefined, {
                                minimumFractionDigits: 3, maximumFractionDigits: 3
                            }) : 'N/A'}</p>
                        </div>
                    </div>
                ...
                <div class="status">
                    ...
                    <div class="container">
                        <div class="item">
                            <p class="str">${coin.tickers[0].market.name}</p>
                            <div class="links">
                        ...
                        <div class="item">
                            <p class="str">${coin.tickers[1].market.name}</p>
                            <div class="links">
                        ...
                        <div class="item">
                            <p class="str">${coin.tickers[2].market.name}</p>
                            <div class="links">
